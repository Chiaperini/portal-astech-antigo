<?php
	...
	$url_vistas = "http://chiaperini.com.br/paste_pa/media/vistas-explodidas/";
	$url_atual = "http://portalastech.chiaperini.com.br/";
	...
	function logarUsuario($login, $senha){ //verifica se o usuario tem cadastro de login
		$mysqli = new mysqli('localhost', 'paste_pa', 'Mudar123', 'paste_pa'); 
		$senha = $senha;
